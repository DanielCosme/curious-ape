...
func (o *OauthToken) pkEQ() dialect.Expression {
	return sqlite.Quote("oauth_token", "id").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
...
func (o OauthTokenSlice) pkIN() dialect.Expression {
	...
	return sqlite.Quote("oauth_token", "id").In(bob.ExpressionFunc(func(ctx context.Context, w io.Writer, d bob.Dialect, start int) ([]any, error) {
