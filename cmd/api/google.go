...
func (a *application) authorizeGoogleHandler(rw http.ResponseWriter, r *http.Request) {
	reqURL := a.collectors.Fit.AuthorizationURI()
	http.Redirect(rw, r, reqURL, http.StatusFound)
}

func (a *application) successGoogleHandler(rw http.ResponseWriter, r *http.Request) {
	err := r.ParseForm()
	if err != nil {
