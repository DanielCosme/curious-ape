...
// )
//
// func (a *main.application) dayGetHandler(rw http.ResponseWriter, r *http.Request) {
// 	r.ParseForm()
// 	d := r.Form.Get("day")
//
...
// }
//
// func (a *main.application) miscHandler(rw http.ResponseWriter, r *http.Request) {
//
...
// }
//
// func (a *main.application) seedDataHandler(rw http.ResponseWriter, r *http.Request) {
// 	t := time.Now()
//
