...
type habitRelationshipJoins[Q dialect.Joinable] struct {
	HabitLogs     bob.Mod[Q]
	Day           bob.Mod[Q]
	HabitCategory bob.Mod[Q]
}

func buildHabitRelationshipJoins[Q dialect.Joinable](ctx context.Context, typ string) habitRelationshipJoins[Q] {
	return habitRelationshipJoins[Q]{
		HabitLogs:     habitsJoinHabitLogs[Q](ctx, typ),
		Day:           habitsJoinDay[Q](ctx, typ),
		HabitCategory: habitsJoinHabitCategory[Q](ctx, typ),
	}
}

func habitsJoin[Q dialect.Joinable](ctx context.Context) joinSet[habitRelationshipJoins[Q]] {
	return joinSet[habitRelationshipJoins[Q]]{
		InnerJoin: buildHabitRelationshipJoins[Q](ctx, clause.InnerJoin),
		LeftJoin:  buildHabitRelationshipJoins[Q](ctx, clause.LeftJoin),
		RightJoin: buildHabitRelationshipJoins[Q](ctx, clause.RightJoin),
	}
}
...
var HabitColumns = struct {
	...
	ID:              sqlite.Quote("habits", "id"),
	DayID:           sqlite.Quote("habits", "day_id"),
	HabitCategoryID: sqlite.Quote("habits", "habit_category_id"),
	State:           sqlite.Quote("habits", "state"),
}
...
func habitsJoinHabitLogs[Q dialect.Joinable](ctx context.Context, typ string) bob.Mod[Q] {
	return mods.QueryMods[Q]{
		dialect.Join[Q](typ, HabitLogs.NameAs(ctx)).On(
			HabitLogColumns.HabitID.EQ(HabitColumns.ID),
		),
	}
}

func habitsJoinDay[Q dialect.Joinable](ctx context.Context, typ string) bob.Mod[Q] {
	return mods.QueryMods[Q]{
		dialect.Join[Q](typ, Days.NameAs(ctx)).On(
			DayColumns.ID.EQ(HabitColumns.DayID),
		),
	}
}

func habitsJoinHabitCategory[Q dialect.Joinable](ctx context.Context, typ string) bob.Mod[Q] {
	return mods.QueryMods[Q]{
		dialect.Join[Q](typ, HabitCategories.NameAs(ctx)).On(
			HabitCategoryColumns.ID.EQ(HabitColumns.HabitCategoryID),
		),
	}
}
