...
var AuthColumns = struct {
	...
	ID:           sqlite.Quote("auths", "id"),
	Provider:     sqlite.Quote("auths", "provider"),
	AccessToken:  sqlite.Quote("auths", "access_token"),
	RefreshToken: sqlite.Quote("auths", "refresh_token"),
	TokenType:    sqlite.Quote("auths", "token_type"),
	Expiration:   sqlite.Quote("auths", "expiration"),
}
...
func AuthWhere[Q sqlite.Filterable]() authWhere[Q] {
	return authWhere[Q]{
		ID:           sqlite.Where[Q, int32](AuthColumns.ID),
		Provider:     sqlite.Where[Q, string](AuthColumns.Provider),
		AccessToken:  sqlite.Where[Q, string](AuthColumns.AccessToken),
		RefreshToken: sqlite.WhereNull[Q, string](AuthColumns.RefreshToken),
		TokenType:    sqlite.WhereNull[Q, string](AuthColumns.TokenType),
		Expiration:   sqlite.WhereNull[Q, time.Time](AuthColumns.Expiration),
	}
}
