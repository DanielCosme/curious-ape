...
type sleepLogRelationshipJoins[Q dialect.Joinable] struct {
	Day bob.Mod[Q]
}

func buildSleepLogRelationshipJoins[Q dialect.Joinable](ctx context.Context, typ string) sleepLogRelationshipJoins[Q] {
	return sleepLogRelationshipJoins[Q]{
		Day: sleepLogsJoinDay[Q](ctx, typ),
	}
}

func sleepLogsJoin[Q dialect.Joinable](ctx context.Context) joinSet[sleepLogRelationshipJoins[Q]] {
	return joinSet[sleepLogRelationshipJoins[Q]]{
		InnerJoin: buildSleepLogRelationshipJoins[Q](ctx, clause.InnerJoin),
		LeftJoin:  buildSleepLogRelationshipJoins[Q](ctx, clause.LeftJoin),
		RightJoin: buildSleepLogRelationshipJoins[Q](ctx, clause.RightJoin),
	}
}

var SleepLogColumns = struct {
	...
	ID:             sqlite.Quote("sleep_logs", "id"),
	DayID:          sqlite.Quote("sleep_logs", "day_id"),
	Date:           sqlite.Quote("sleep_logs", "date"),
	StartTime:      sqlite.Quote("sleep_logs", "start_time"),
	EndTime:        sqlite.Quote("sleep_logs", "end_time"),
	IsMainSleep:    sqlite.Quote("sleep_logs", "is_main_sleep"),
	IsAutomated:    sqlite.Quote("sleep_logs", "is_automated"),
	Origin:         sqlite.Quote("sleep_logs", "origin"),
	TotalTimeInBed: sqlite.Quote("sleep_logs", "total_time_in_bed"),
	MinutesAsleep:  sqlite.Quote("sleep_logs", "minutes_asleep"),
	MinutesRem:     sqlite.Quote("sleep_logs", "minutes_rem"),
	MinutesDeep:    sqlite.Quote("sleep_logs", "minutes_deep"),
	MinutesLight:   sqlite.Quote("sleep_logs", "minutes_light"),
	MinutesAwake:   sqlite.Quote("sleep_logs", "minutes_awake"),
	Raw:            sqlite.Quote("sleep_logs", "raw"),
}
...
func SleepLogWhere[Q sqlite.Filterable]() sleepLogWhere[Q] {
	return sleepLogWhere[Q]{
		ID:             sqlite.Where[Q, int32](SleepLogColumns.ID),
		DayID:          sqlite.Where[Q, int32](SleepLogColumns.DayID),
		Date:           sqlite.Where[Q, time.Time](SleepLogColumns.Date),
		StartTime:      sqlite.Where[Q, time.Time](SleepLogColumns.StartTime),
		EndTime:        sqlite.Where[Q, time.Time](SleepLogColumns.EndTime),
		IsMainSleep:    sqlite.WhereNull[Q, bool](SleepLogColumns.IsMainSleep),
		IsAutomated:    sqlite.WhereNull[Q, bool](SleepLogColumns.IsAutomated),
		Origin:         sqlite.Where[Q, string](SleepLogColumns.Origin),
		TotalTimeInBed: sqlite.WhereNull[Q, int32](SleepLogColumns.TotalTimeInBed),
		MinutesAsleep:  sqlite.WhereNull[Q, int32](SleepLogColumns.MinutesAsleep),
		MinutesRem:     sqlite.WhereNull[Q, int32](SleepLogColumns.MinutesRem),
		MinutesDeep:    sqlite.WhereNull[Q, int32](SleepLogColumns.MinutesDeep),
		MinutesLight:   sqlite.WhereNull[Q, int32](SleepLogColumns.MinutesLight),
		MinutesAwake:   sqlite.WhereNull[Q, int32](SleepLogColumns.MinutesAwake),
		Raw:            sqlite.WhereNull[Q, string](SleepLogColumns.Raw),
	}
}
...
func sleepLogsJoinDay[Q dialect.Joinable](ctx context.Context, typ string) bob.Mod[Q] {
	return mods.QueryMods[Q]{
		dialect.Join[Q](typ, Days.NameAs(ctx)).On(
			DayColumns.ID.EQ(SleepLogColumns.DayID),
		),
	}
}
