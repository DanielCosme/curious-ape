...
var DeepWorkLogs = sqlite.NewTablex[*DeepWorkLog, DeepWorkLogSlice, *DeepWorkLogSetter]("", "deep_work_log", buildDeepWorkLogColumns("deep_work_log"), deepWorkLogScanMapper)
...
func deepWorkLogScanMapper(ctx context.Context, cols []string) (scan.BeforeFunc, func(any) (*DeepWorkLog, error)) {
	// resolve the column positions once per query, not per row
	type target struct {
		idx int
		dst func(o *DeepWorkLog) any
	}
	targets := make([]target, 0, 8)
	for i, col := range cols {
		switch col {
		case "id":
			targets = append(targets, target{i, func(o *DeepWorkLog) any { return &o.ID }})
		case "day_id":
			targets = append(targets, target{i, func(o *DeepWorkLog) any { return &o.DayID }})
		case "title":
			targets = append(targets, target{i, func(o *DeepWorkLog) any { return &o.Title }})
		case "start_time":
			targets = append(targets, target{i, func(o *DeepWorkLog) any { return &o.StartTime }})
		case "end_time":
			targets = append(targets, target{i, func(o *DeepWorkLog) any { return &o.EndTime }})
		case "note":
			targets = append(targets, target{i, func(o *DeepWorkLog) any { return &o.Note }})
		case "origin":
			targets = append(targets, target{i, func(o *DeepWorkLog) any { return &o.Origin }})
		case "raw":
			targets = append(targets, target{i, func(o *DeepWorkLog) any { return &o.Raw }})
		}
	}
	...
	return func(row *scan.Row) (any, error) {
			...
			return o, nil
		}, func(v any) (*DeepWorkLog, error) {
			return v.(*DeepWorkLog), nil
		}
}
...
func (o DeepWorkLogSlice) copyMatchingRows(from ...*DeepWorkLog) {
	fromByPK := make(map[int64]*DeepWorkLog, len(from))
...
func buildDeepWorkLogWhere[Q sqlite.Filterable](cols deepWorkLogColumns) deepWorkLogWhere[Q] {
	return deepWorkLogWhere[Q]{
		...
		R:         deepWorkLogWhereR[Q]{cols: cols},
	}
}

// deepWorkLogWhereR holds the relationship-based filters of
// deepWorkLogWhere under the R namespace — mirroring the model's
// R struct — so they cannot collide with column-based filter fields.
type deepWorkLogWhereR[Q sqlite.Filterable] struct {
	cols deepWorkLogColumns
}
...
func (w deepWorkLogWhereR[Q]) HasDay(filters ...bob.Mod[*dialect.SelectQuery]) mods.Where[Q] {
	q := sqlite.Select(
