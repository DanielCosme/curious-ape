...
var OauthTokens = sqlite.NewTablex[*OauthToken, OauthTokenSlice, *OauthTokenSetter]("", "oauth_token", buildOauthTokenColumns("oauth_token"), oauthTokenScanMapper)
...
func oauthTokenScanMapper(ctx context.Context, cols []string) (scan.BeforeFunc, func(any) (*OauthToken, error)) {
	// resolve the column positions once per query, not per row
	type target struct {
		idx int
		dst func(o *OauthToken) any
	}
	targets := make([]target, 0, 6)
	for i, col := range cols {
		switch col {
		case "id":
			targets = append(targets, target{i, func(o *OauthToken) any { return &o.ID }})
		case "provider":
			targets = append(targets, target{i, func(o *OauthToken) any { return &o.Provider }})
		case "access_token":
			targets = append(targets, target{i, func(o *OauthToken) any { return &o.AccessToken }})
		case "refresh_token":
			targets = append(targets, target{i, func(o *OauthToken) any { return &o.RefreshToken }})
		case "token_type":
			targets = append(targets, target{i, func(o *OauthToken) any { return &o.TokenType }})
		case "expiration":
			targets = append(targets, target{i, func(o *OauthToken) any { return &o.Expiration }})
		}
	}
...
func (o OauthTokenSlice) copyMatchingRows(from ...*OauthToken) {
	fromByPK := make(map[int64]*OauthToken, len(from))
