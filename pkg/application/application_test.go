...
func TestDay(t *testing.T) {
	...
	test.True(t, days[0].Habits.Hs[0].Date.IsEqual(days[0].Date.Time()))
	test.True(t, days[0].Habits.Hs[0].ID == habit1.ID)
	test.True(t, days[0].Habits.Hs[1].ID == habit2.ID)
	test.True(t, days[0].Habits.Hs[2].ID == habit3.ID)
	test.True(t, days[0].Habits.Hs[3].ID == habit4.ID)
	test.True(t, len(days[1].Habits.Hs) == 4)
	test.True(t, days[1].Habits.Hs[0].State == core.HabitStateNoInfo)
	test.True(t, days[1].Habits.Hs[1].State == core.HabitStateNoInfo)
	test.True(t, days[1].Habits.Hs[2].State == core.HabitStateNoInfo)
	test.True(t, days[1].Habits.Hs[3].State == core.HabitStateNoInfo)
