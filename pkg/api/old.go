...
func (a *OldAPI) ServeStaticAssets(c *dove.Context) (err error) {
...
func (a *OldAPI) IntegrationGet(c *dove.Context) error {
	c.ParseForm()
...
func (a *OldAPI) IntegrationsGetList(c *dove.Context) error {
...
func (a *OldAPI) HabitFlip(c *dove.Context) error {
	c.ParseForm()
...
func (a *OldAPI) GetLoginForm(c *dove.Context) error {
...
func (a *OldAPI) Login(c *dove.Context) error {
...
func (a *OldAPI) Logout(c *dove.Context) error {
